  ...
  return (
    <div className='flex justify-center align-middle p-20'>
      ...
      <div className='flex flex-col mb-5'>
        ...
        <button type="submit" disabled={loading} className='bg-green-500 px-5 py-2 rounded-md text-white font-bold text-center text-lg hover:bg-green-400 mt-5 w-[100%]'>{loading ? <div className='spinner'></div> : "Sign In"}</button>
